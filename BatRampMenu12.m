...
@interface BatRampMenu12 ()

@end

@implementation BatRampMenu12
...
*/
    ...
    nextButton.backgroundColor = [UIColor colorWithRed: 0.80 green: 0.80 blue: 0.80 alpha: 1.00];
    ...
    cancelButton.backgroundColor =[UIColor colorWithRed: 0.80 green: 0.80 blue: 0.80 alpha: 0.80];
